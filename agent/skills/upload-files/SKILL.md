---
name: upload-files
description: Upload files to the ImageKit media library via DAM MCP. Use
  upload_file (interactive picker) for local files; create_upload_signature for
  a public URL or CLI upload. Never inline file bytes into the conversation.
---
# Upload files

...
description: Share or revoke access on ImageKit files, folders, and media
  collections via DAM MCP. Use when the user asks who can see an asset, to grant
  READ/CONTRIBUTE/MANAGE, or to add/remove a user or group from an ACL.
---

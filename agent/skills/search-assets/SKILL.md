---
name: search-assets
description: Lucene searchQuery cheatsheet for DAM search_media_library. Use
  when the user describes assets in everyday language (brand, campaign, region,
  status, colour, rating, SKU) or when building or debugging a search, filter,
  or list of ImageKit files and folders.
---

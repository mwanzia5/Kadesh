...
const keyFacts = [
  { icon: Globe, value: "50+", label: "Communities Served" },
  { icon: Wrench, value: "100+", label: "Projects Completed" },
  { icon: Users, value: "100%", label: "Community-Led" },
];
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <OptimizedImage
          src="/images/others/south-africa-cape-town-langa-boys-balancing-on-seesaw.webp"
      ...
      <div className="relative z-10 w-full">
        <Container>
          <div className="flex flex-col items-center text-center text-white py-32">
            ...
            >
              Empowering communities to drive their own sustainable development
            </motion.p>
        ...
        <div className="max-w-4xl mx-auto">
          <ScrollReveal>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-vibrant-blue/10 flex items-center justify-center">
                <HandHeart className="h-6 w-6 text-vibrant-blue" />
              </div>
          ...
          <ScrollReveal delay={0.2}>
            <div className="space-y-6 font-body text-body-lg text-on-surface leading-relaxed">
              <p>
                Our community development initiatives address the diverse needs of the communities we serve. From infrastructure development to skills training, we work alongside community members to create sustainable solutions.
              </p>
              <p>
                We believe in empowering communities to drive their own development. Through participatory planning and local leadership, our projects are designed to be sustainable and impactful.
              </p>
              <p>
                Our community projects include infrastructure improvement, clean water access, sanitation facilities, and community gathering spaces. Each initiative is tailored to the specific needs of the community.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.3} className="mt-10">
            <div className="flex flex-wrap gap-4">
              {["Infrastructure Development", "Clean Water Access", "Sanitation Facilities", "Skills Training"].map(
                (tag) => (
                  <span
                    key={tag}
    ...
    <Section background="white" className="section-padding">
      <Container>
        <SectionHeading
          ...
          subtitle="Key facts about our Community Projects"
        />
        ...
        <ScrollReveal>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="font-body text-body-lg text-white/70 mb-10 leading-relaxed">
              Your donation helps us provide essential infrastructure, clean water, and development programs to communities across Africa. Together, we can create lasting change.
            </p>

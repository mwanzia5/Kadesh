...
const galleryImages = [
  { src: "/images/womensproject_1.jpeg", alt: "Women empowerment program" },
  { src: "/images/kadesh images_08.jpg", alt: "Skills training" },
  { src: "/images/kadesh images_09.jpg", alt: "Micro-financing initiative" },
  { src: "/images/kadesh images_10.jpg", alt: "Women entrepreneurs" },
];

const keyFacts = [
  { icon: Users, value: "500+", label: "Women Empowered" },
  { icon: Briefcase, value: "200+", label: "Businesses Started" },
  { icon: Banknote, value: "100%", label: "Micro-Financing Available" },
];

export default function WomenProjects() {
  return (
    <PageTransition>
      <HeroSection />
      <StorySection />
    ...
    <Section background="gray" className="section-padding">
      <Container>
        <SectionHeading
          ...
          subtitle="Moments from our Women Projects"
        />
    ...
    <Section background="white" className="section-padding">
      <Container>
        <SectionHeading
          ...
          subtitle="Key facts about our Women Projects"
        />
        ...
        <ScrollReveal>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="font-body text-body-lg text-white/70 mb-10 leading-relaxed">
              Your donation helps us provide micro-financing, skills training, and mentorship to women across Africa. Together, we can create a ripple effect of positive change.
            </p>
